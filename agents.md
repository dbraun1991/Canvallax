...
- **Resize handles need a visible affordance**, and dragging one to zero-width should minimize that panel. Both the Issue sidebar and Backlog panel support drag-to-resize, but the hit-area is invisible.

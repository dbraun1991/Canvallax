...
The shell UI is English-only today; multi-language support (English + German to start) is planned but not yet built — see [ADR-0026](docs/adr/0026-multi-language-shell-ui-i18next.md).
